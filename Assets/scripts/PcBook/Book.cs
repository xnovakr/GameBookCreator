...
public class Book : MonoBehaviour {
    ...
    public Sprite CoverLeft;
    public Sprite CoverRight;
    ...
    public Image LeftNextNext;
    public Image Right;
    public Image RightNext;
    public Image RightNextNext;
    ...
    public void DragRightPageToPoint(Vector3 point)
    {
        ...
        Left.sprite =  (currentPage < bookPages.Length) ? bookPages[currentPage] : CoverLeft;// RightNext.sprite;//
        Left.transform.SetAsFirstSibling();
        
        Right.gameObject.SetActive(true);
        Right.transform.position = RightNext.transform.position;
        Right.transform.eulerAngles = new Vector3(0, 0, 0);
        Right.sprite = (currentPage < bookPages.Length - 1) ? bookPages[currentPage + 1] : CoverRight;//LeftNext.sprite;//

        //LeftNextNext.sprite = LeftNext.sprite;
        //RightNextNext.sprite = (currentPage < bookPages.Length - 4) ? bookPages[currentPage + 4] : CoverRight;// should be next page not right
        RightNext.sprite = (currentPage < bookPages.Length - 2) ? bookPages[currentPage + 2] : CoverRight;

        LeftNext.transform.SetAsFirstSibling();
        LeftNextNext.transform.SetAsFirstSibling();
    ...
    public void DragLeftPageToPoint(Vector3 point)
    {
        ...
        Left.transform.eulerAngles = new Vector3(0, 0, 0);
        Left.sprite = (currentPage >= 2) ? bookPages[currentPage - 2] : CoverLeft;

        //LeftNextNext.sprite = (currentPage - 5 > 0) ? bookPages[currentPage - 5] : CoverLeft; // should be previous page not right isiel som opacnym smerom
        //RightNextNext.sprite = RightNext.sprite;
        LeftNext.sprite = (currentPage >= 3) ? bookPages[currentPage - 3] : CoverLeft;

        RightNext.transform.SetAsFirstSibling();
        RightNextNext.transform.SetAsFirstSibling();
    ...
    void UpdateSprites()
    {
        LeftNextNext.sprite = (currentPage - 3 > 0) ? bookPages[currentPage - 3] : CoverLeft;
        RightNextNext.sprite = (currentPage < bookPages.Length - 2) ? bookPages[currentPage + 2] : CoverRight;// should be next page not right
        LeftNext.sprite= (currentPage > 0 && currentPage <= bookPages.Length) ? bookPages[currentPage-1] : CoverLeft;
        RightNext.sprite=(currentPage>=0 &&currentPage<bookPages.Length) ? bookPages[currentPage] : CoverRight;
    }
